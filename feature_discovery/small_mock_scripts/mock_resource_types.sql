...
CREATE TABLE `resource_types` (
  ...
  `resource_type_medium` varchar(20) DEFAULT NULL,
...
INSERT INTO `resource_types` VALUES (0,'other',NULL),(1,'lecture','video'),(2,'wiki',NULL),(3,'book',NULL),(4,'profile',NULL),(7,'tutorial','video'),(8,'exam',NULL),(9,'problem',NULL),(10,'informational','text'),(19,'testing',NULL);
...
-- Dump completed on 2013-10-04  4:13:45
